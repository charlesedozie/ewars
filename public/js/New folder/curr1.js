...
//document.getElementById("controlBtnConcBody").style.display = "none"
...
window.addEventListener('load', (event) => { startRunApp = setInterval(runApp, 1000); stopFormSubmit('form1', 'form2'); reConnect();});
