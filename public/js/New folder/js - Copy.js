...
function updateMediaBtn(media){
switch(parseInt(media)) {
case 43:
//document.getElementByd("screenShare").innerHTML = '<i class="fas fa-desktop iconDisable mx-1" title="Screen Share (Disabled)" aria-hidden="true">screen</i>';
console.log("data.settings.length");
break;  
case 12:
